...
<table><tr><td><u>DELETE TASK</u></td></tr></table>
    <div>
    <form action=DeleteTask.jsp method="post">
            ...
            <button type="submit" value="Delete Task">Delete Task</button>
            <button value="Dashboard">Dashboard</button>
        </form>
    </div> 
    <script>
        function submitForm(action) {
            document.getElementById('CreateTask').action = action === 'submit' ? 'Delete.jsp' : 'Main.jsp';
            document.getElementById('CreateTask').submit();
        }
    </script>
</body>
</html>
